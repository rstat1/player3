...
namespace app
{
	...
	void App::OnInitComplete()
	{
		...
		EmberService::Get()->SetEmberWebSocketURL("wss://api.alargerobot.dev/ember/ws");
		EmberService::Get()->SetEmberConnectURL("https://api.alargerobot.dev/ember/client/connect");
		EmberService::Get()->SetEmberUpdateCheckURL("https://api.alargerobot.dev/ember/updates/check");
		EmberService::Get()->SetEmberUpdateDownloadURL("https://api.alargerobot.dev/ember/updates/get");
